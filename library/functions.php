...
//	$accno 	= (int)$_POST['accno'];
	...
	*/
	...
	This is to inform you that your Account # $accno is register successfully with x Bank and currently in Inactive state. We will soon contact you once it get activate.<br/><br/>In case you need any further clarification for the same, please do get in touch with your Home Branch.<br/><br/>
	Regards,<br/>x Bank";
